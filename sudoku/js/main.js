...
var successFun = function successFun() {
  var tip = _config.SUCCESS_TIP[parseInt((0, _jquery2.default)('#jumpList').val()) % _config.SUCCESS_TIP.length];
  (0, _jquery2.default)('#overTip').html(tip);
};
var errorFun = function errorFun() {
  var tip = _config.ERROR_TIP[parseInt((0, _jquery2.default)('#jumpList').val()) % _config.ERROR_TIP.length];
  (0, _jquery2.default)('#overTip').html(tip);
};
